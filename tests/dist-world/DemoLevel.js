...
function buildDemoLevel() {
    ...
    // ==========================================
    {
        ...
        fillBox(tiles, 15, 2, 15, 5, ScreenData_1.TileType.ONE_WAY); // y=600, first step
        fillBox(tiles, 12, 3, 12, 6, ScreenData_1.TileType.ONE_WAY); // y=480, mid-left
        // Right ascending platforms (mirror)
        fillBox(tiles, 15, 14, 15, 17, ScreenData_1.TileType.ONE_WAY); // y=600, first step
        fillBox(tiles, 12, 13, 12, 16, ScreenData_1.TileType.ONE_WAY); // y=480, mid-right
        // Central elevated treasure platform
        fillBox(tiles, 9, 8, 9, 11, ScreenData_1.TileType.ONE_WAY); // y=360, holds prism
        const spikeProps = {};
    ...
    // ==========================================
    {
        ...
        tiles[15][2] = ScreenData_1.TileType.SOLID;
        tiles[15][17] = ScreenData_1.TileType.SOLID;
        ...
        fillBox(tiles, 7, 7, 7, 8, ScreenData_1.TileType.ONE_WAY);
        fillBox(tiles, 7, 11, 7, 12, ScreenData_1.TileType.ONE_WAY);
        const spikeProps = {};
