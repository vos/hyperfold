...
function buildDemoLevel() {
    ...
    // ==========================================
    {
        ...
        fillBox(tiles, 15, 4, 15, 7, ScreenData_1.TileType.ONE_WAY);
        fillBox(tiles, 12, 8, 12, 11, ScreenData_1.TileType.SOLID);
        fillBox(tiles, 15, 12, 15, 15, ScreenData_1.TileType.ONE_WAY);
        const room = {
            id: 'room_5_0',
            coords: { x: 5, y: 0 },
